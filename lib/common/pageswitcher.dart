...
///
/// When a [PageTransitionSwitcher2]'s `child` is replaced, the new child's
...
/// but with different parameters, then [PageTransitionSwitcher2] will *not* do a
...
class PageTransitionSwitcher2 extends StatefulWidget {
  /// Creates a [PageTransitionSwitcher2].
  ///
  /// The [duration], [reverse], [transitionBuilder] and [alignment] parameters
  /// must not be null.
  const PageTransitionSwitcher2({
    Key key,
  ...
  /// return null.
  ///
  /// The default is [PageTransitionSwitcher2.defaultLayoutBuilder].
  ///
  /// See also:
  ///
  ...
  @override
  _PageTransitionSwitcher2State createState() => _PageTransitionSwitcher2State();
}

class _PageTransitionSwitcher2State extends State<PageTransitionSwitcher2>
  ...
  @override
  void didUpdateWidget(PageTransitionSwitcher2 oldWidget) {
