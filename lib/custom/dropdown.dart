    ...
    return FadeTransition(
      ...
      child: CustomPaint(
        ...
        child: Semantics(
          ...
          child: ClipRRect(
            borderRadius: BorderRadius.circular(route.radius),
            child: Material(
...
class CustomDropdownButtonHideUnderline extends InheritedWidget {
  ...
  static bool at(BuildContext context) {
    return context.inheritFromWidgetOfExactType(CustomDropdownButtonHideUnderline) != null;
  }
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  ///
  /// The [elevation], [radius] and [iconSize] arguments must not be null (all of
  /// them have defaults, so do not need to be specified). The boolean [isDense] and
  ...
  }) : assert(items == null || items.isEmpty || value == null || items.where((CustomDropdownMenuItem<T> item) => item.value == value).length == 1),
  ...
  /// The radius of the dropdown menu.
  ///
  /// Defaults to 2.0.
  final double radius;
...
class _CustomDropdownButtonState<T> extends State<CustomDropdownButton<T>> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.hint != null || (!_enabled && widget.disabledHint != null)) {
      ...
      _enabled ? widget.hint : CustomDropdownMenuItem<Widget>(child: widget.disabledHint ?? widget.hint);
